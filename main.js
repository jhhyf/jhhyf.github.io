let links = ["https://vignette2.wikia.nocookie.net/diepio/images/d/d6/Tanksksksksk.png/revision/latest?cb=20160906115151",
...
let titles = ["Diep.io level 0 tank", "Minecraft end dragon", "Minecraft world",];
let index = 0;
let autoplay = true;
